...
> Custom add-on bar types (for example NinzaRenko/UniRenko) are intentionally not supported so this indicator stays dependency-free in a stock NT8 install.
