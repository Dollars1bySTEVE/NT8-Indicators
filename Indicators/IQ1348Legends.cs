...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private IQ1348Legends[] cacheIQ1348Legends;
		public IQ1348Legends IQ1348Legends(bool showEma13, System.Windows.Media.Brush ema13Color, int ema13Thickness, bool showEma48, System.Windows.Media.Brush ema48Color, int ema48Thickness, bool showEma200, System.Windows.Media.Brush ema200Color, int ema200Thickness, bool showEmaLabels, bool showRibbon, System.Windows.Media.Brush ribbonBullColor, System.Windows.Media.Brush ribbonBearColor, int ribbonOpacity, bool showLowVolumeCandles, int volumePeriod, double volumeThreshold, bool showSignals, int signalFontSize, int signalOffsetTicks, bool playAlertSound, bool showPriceLevels, double levelSpacing, System.Windows.Media.Brush levelColor, bool showBiasLabel)
		{
			return IQ1348Legends(Input, showEma13, ema13Color, ema13Thickness, showEma48, ema48Color, ema48Thickness, showEma200, ema200Color, ema200Thickness, showEmaLabels, showRibbon, ribbonBullColor, ribbonBearColor, ribbonOpacity, showLowVolumeCandles, volumePeriod, volumeThreshold, showSignals, signalFontSize, signalOffsetTicks, playAlertSound, showPriceLevels, levelSpacing, levelColor, showBiasLabel);
		}

		public IQ1348Legends IQ1348Legends(ISeries<double> input, bool showEma13, System.Windows.Media.Brush ema13Color, int ema13Thickness, bool showEma48, System.Windows.Media.Brush ema48Color, int ema48Thickness, bool showEma200, System.Windows.Media.Brush ema200Color, int ema200Thickness, bool showEmaLabels, bool showRibbon, System.Windows.Media.Brush ribbonBullColor, System.Windows.Media.Brush ribbonBearColor, int ribbonOpacity, bool showLowVolumeCandles, int volumePeriod, double volumeThreshold, bool showSignals, int signalFontSize, int signalOffsetTicks, bool playAlertSound, bool showPriceLevels, double levelSpacing, System.Windows.Media.Brush levelColor, bool showBiasLabel)
		{
			if (cacheIQ1348Legends != null)
				for (int idx = 0; idx < cacheIQ1348Legends.Length; idx++)
					if (cacheIQ1348Legends[idx] != null && cacheIQ1348Legends[idx].ShowEma13 == showEma13 && cacheIQ1348Legends[idx].Ema13Color == ema13Color && cacheIQ1348Legends[idx].Ema13Thickness == ema13Thickness && cacheIQ1348Legends[idx].ShowEma48 == showEma48 && cacheIQ1348Legends[idx].Ema48Color == ema48Color && cacheIQ1348Legends[idx].Ema48Thickness == ema48Thickness && cacheIQ1348Legends[idx].ShowEma200 == showEma200 && cacheIQ1348Legends[idx].Ema200Color == ema200Color && cacheIQ1348Legends[idx].Ema200Thickness == ema200Thickness && cacheIQ1348Legends[idx].ShowEmaLabels == showEmaLabels && cacheIQ1348Legends[idx].ShowRibbon == showRibbon && cacheIQ1348Legends[idx].RibbonBullColor == ribbonBullColor && cacheIQ1348Legends[idx].RibbonBearColor == ribbonBearColor && cacheIQ1348Legends[idx].RibbonOpacity == ribbonOpacity && cacheIQ1348Legends[idx].ShowLowVolumeCandles == showLowVolumeCandles && cacheIQ1348Legends[idx].VolumePeriod == volumePeriod && cacheIQ1348Legends[idx].VolumeThreshold == volumeThreshold && cacheIQ1348Legends[idx].ShowSignals == showSignals && cacheIQ1348Legends[idx].SignalFontSize == signalFontSize && cacheIQ1348Legends[idx].SignalOffsetTicks == signalOffsetTicks && cacheIQ1348Legends[idx].PlayAlertSound == playAlertSound && cacheIQ1348Legends[idx].ShowPriceLevels == showPriceLevels && cacheIQ1348Legends[idx].LevelSpacing == levelSpacing && cacheIQ1348Legends[idx].LevelColor == levelColor && cacheIQ1348Legends[idx].ShowBiasLabel == showBiasLabel && cacheIQ1348Legends[idx].EqualsInput(input))
						return cacheIQ1348Legends[idx];
			return CacheIndicator<IQ1348Legends>(new IQ1348Legends(){ ShowEma13 = showEma13, Ema13Color = ema13Color, Ema13Thickness = ema13Thickness, ShowEma48 = showEma48, Ema48Color = ema48Color, Ema48Thickness = ema48Thickness, ShowEma200 = showEma200, Ema200Color = ema200Color, Ema200Thickness = ema200Thickness, ShowEmaLabels = showEmaLabels, ShowRibbon = showRibbon, RibbonBullColor = ribbonBullColor, RibbonBearColor = ribbonBearColor, RibbonOpacity = ribbonOpacity, ShowLowVolumeCandles = showLowVolumeCandles, VolumePeriod = volumePeriod, VolumeThreshold = volumeThreshold, ShowSignals = showSignals, SignalFontSize = signalFontSize, SignalOffsetTicks = signalOffsetTicks, PlayAlertSound = playAlertSound, ShowPriceLevels = showPriceLevels, LevelSpacing = levelSpacing, LevelColor = levelColor, ShowBiasLabel = showBiasLabel }, input, ref cacheIQ1348Legends);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.IQ1348Legends IQ1348Legends(bool showEma13, System.Windows.Media.Brush ema13Color, int ema13Thickness, bool showEma48, System.Windows.Media.Brush ema48Color, int ema48Thickness, bool showEma200, System.Windows.Media.Brush ema200Color, int ema200Thickness, bool showEmaLabels, bool showRibbon, System.Windows.Media.Brush ribbonBullColor, System.Windows.Media.Brush ribbonBearColor, int ribbonOpacity, bool showLowVolumeCandles, int volumePeriod, double volumeThreshold, bool showSignals, int signalFontSize, int signalOffsetTicks, bool playAlertSound, bool showPriceLevels, double levelSpacing, System.Windows.Media.Brush levelColor, bool showBiasLabel)
		{
			return indicator.IQ1348Legends(Input, showEma13, ema13Color, ema13Thickness, showEma48, ema48Color, ema48Thickness, showEma200, ema200Color, ema200Thickness, showEmaLabels, showRibbon, ribbonBullColor, ribbonBearColor, ribbonOpacity, showLowVolumeCandles, volumePeriod, volumeThreshold, showSignals, signalFontSize, signalOffsetTicks, playAlertSound, showPriceLevels, levelSpacing, levelColor, showBiasLabel);
		}

		public Indicators.IQ1348Legends IQ1348Legends(ISeries<double> input , bool showEma13, System.Windows.Media.Brush ema13Color, int ema13Thickness, bool showEma48, System.Windows.Media.Brush ema48Color, int ema48Thickness, bool showEma200, System.Windows.Media.Brush ema200Color, int ema200Thickness, bool showEmaLabels, bool showRibbon, System.Windows.Media.Brush ribbonBullColor, System.Windows.Media.Brush ribbonBearColor, int ribbonOpacity, bool showLowVolumeCandles, int volumePeriod, double volumeThreshold, bool showSignals, int signalFontSize, int signalOffsetTicks, bool playAlertSound, bool showPriceLevels, double levelSpacing, System.Windows.Media.Brush levelColor, bool showBiasLabel)
		{
			return indicator.IQ1348Legends(input, showEma13, ema13Color, ema13Thickness, showEma48, ema48Color, ema48Thickness, showEma200, ema200Color, ema200Thickness, showEmaLabels, showRibbon, ribbonBullColor, ribbonBearColor, ribbonOpacity, showLowVolumeCandles, volumePeriod, volumeThreshold, showSignals, signalFontSize, signalOffsetTicks, playAlertSound, showPriceLevels, levelSpacing, levelColor, showBiasLabel);
		}
	}
