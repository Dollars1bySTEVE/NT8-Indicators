...
namespace NinjaTrader.NinjaScript.Indicators
{
    ...
    public class IQMainUltimate : Indicator
    {
        ...
        /// </summary>
        private void UpdateTPOSession(DateTime barUtc)
        {
            ...
            for (int id = 0; id < 8; id++)
            {
                ...
                DateTime sStart, sEnd;
                GetSessionUtcTimes(id, barUtc, out sStart, out sEnd);
                bool inSession = barUtc >= sStart && barUtc < sEnd;
                ...
                if (inSession)
                {
                    ...
                    UpdateInitialBalance(sess, barUtc);
        ...
        /// </summary>
        private void UpdateInitialBalance(TPOSession sess, DateTime barUtc)
        {
