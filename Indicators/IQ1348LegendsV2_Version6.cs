...
namespace NinjaTrader.NinjaScript.Indicators
{
    public class IQ1348LegendsV2 : Indicator
    {
        ...
        [NinjaScriptProperty]
        [Display(Name = "EMA 48 Bull Color", Order = 6, GroupName = "1. EMA Lines", Description = "Color of the 48 EMA when 13 EMA is above it.")]
        [XmlIgnore]
        ...
        [NinjaScriptProperty]
        [Display(Name = "EMA 48 Bear Color", Order = 7, GroupName = "1. EMA Lines", Description = "Color of the 48 EMA when 13 EMA is below it.")]
        [XmlIgnore]
        public System.Windows.Media.Brush Ema48BearColor { get; set; }
        [Browsable(false)]
        public string Ema48BearColorSerializable
        {
            get => Serialize.BrushToString(Ema48BearColor);
            set => Ema48BearColor = Serialize.StringToBrush(value);
        }

        [NinjaScriptProperty]
        [Range(1, 5)]
        [Display(Name = "EMA 48 Thickness", Order = 8, GroupName = "1. EMA Lines")]
        public int Ema48Thickness { get; set; }

        [NinjaScriptProperty]
        [Display(Name = "Show EMA 200", Order = 9, GroupName = "1. EMA Lines", Description = "Draw the EMA(200) macro filter line.")]
        public bool ShowEma200 { get; set; }

        [NinjaScriptProperty]
        [Display(Name = "EMA 200 Bull Color", Order = 10, GroupName = "1. EMA Lines", Description = "Color of the 200 EMA when price is above it.")]
        [XmlIgnore]
        ...
        [NinjaScriptProperty]
        [Display(Name = "EMA 200 Bear Color", Order = 11, GroupName = "1. EMA Lines", Description = "Color of the 200 EMA when price is below it.")]
        [XmlIgnore]
        ...
        [NinjaScriptProperty]
        [Range(1, 5)]
        [Display(Name = "EMA 200 Thickness", Order = 12, GroupName = "1. EMA Lines")]
        public int Ema200Thickness { get; set; }

        [NinjaScriptProperty]
        [Display(Name = "Show EMA Labels", Order = 13, GroupName = "1. EMA Lines", Description = "Show EMA price labels.")]
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                var ema48BearBrush = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(100, 100, 150));
                ema48BearBrush.Freeze();
                Ema48BearColor = ema48BearBrush;
        ...
        protected override void OnBarUpdate()
        {
            ...
            try
            {
                ...
                // Dynamic EMA 48 coloring (based on 13 vs 48 crossover)
                if (ShowEma48)
                {
                    PlotBrushes[1][0] = (ema13 > ema48) ? Ema48Color : Ema48BearColor;
                }
                ...
                if (ShowEmaLabels)
                {
                    ...
                    if (ShowEma48)
                        Draw.Text(this, "EmaLabel48", false, "EMA48  " + ema48.ToString("F2"), 0, ema48, 0, (ema13 > ema48) ? Ema48Color : Ema48BearColor, _emaLabelFont, System.Windows.TextAlignment.Left, Brushes.Transparent, Brushes.Transparent, 0);
                    if (ShowEma200)
